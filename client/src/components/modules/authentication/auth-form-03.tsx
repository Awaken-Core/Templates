    ...
    <form className={cn("flex flex-col gap-4", className)} {...props}>
      <FieldGroup className="gap-4">
        ...
        <div className="mt-2 flex justify-center">
          <Button type="submit" className="rounded-full px-10 h-11 text-[14px] font-medium shadow-[0_8px_16px_rgba(0,0,0,0.15)] transition-all hover:shadow-[0_4px_8px_rgba(0,0,0,0.1)]">
            Sign In Now
          </Button>
        </div>
      ...
      <div className="text-center mt-6">
        <a href="#" className="text-[12px] text-muted-foreground font-medium hover:text-foreground transition-colors underline-offset-4 hover:underline">
